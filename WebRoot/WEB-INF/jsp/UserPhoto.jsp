		...
		<div class="portrait_left">
			...
			<div class="portrait_revolve">
				...
				<label class="btn-choose-file" style="margin:20px 50px 0 0px;">
					选择照片
					<input id="myFile" type="file"  name="myFile" style="width:0px;height:0px;" onchange="box(this);" change="box(this);"/>
				</label>
				<input  type="button" class="btn-choose-file" onclick="submit_avatar();" value="确定" style="line-height:20px;float: left;margin:20px 0 0 50px;	text-indent: 0px;"/>
		</div>

		<div class="portrait_right">
			<p class="portrait_right_txt">
				您上传的头像会自动生成小尺寸头像，<br>请注意小尺寸的头像是否清晰
			</p>
