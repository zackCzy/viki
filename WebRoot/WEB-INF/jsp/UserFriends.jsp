...
<html>
	<head>
		...
		<link type="text/css" rel="stylesheet" href="/myHome/CSS/UserFriends.css"/>
	...
	<body>
		<div class="Home_page_nav" style="margin:30px auto 0;">
				<ul>
					...
					<li>关系</li>
					<li style="border-bottom: 4px solid #DC3C00;"><a href="/myHome/user/user_myFlans">消息</a></li>
				</ul>
		</div>
		<div class="follw_box">
			...
			<div class="friends_nav">
				<span >最新信息</span>
				<ul>
					<li><a style="color: #3fa7cb;text-decoration:none;display: block;" href="/myHome/user/user_SysMessage">消息</a></li>
					<li><a style="color: #3fa7cb;text-decoration:none;display: block;""  href="/myHome/user/user_myFlans">我的粉丝</a></li>
					<li><a style="color: #3fa7cb;text-decoration:none;display: block;"" href="/myHome/user/user_myFollwer">关注的人</a></li>
					<li><a style="color: #3fa7cb;text-decoration:none;display: block;"" href="/myHome/user/user_communMessage">私信</a></li>
					<li><a style="color: #3fa7cb;text-decoration:none;display: block;"" href="/myHome/user/user_commentMessage">评论</a></li>
					<li>未关注人私信</li>
					<li>收藏</li>
				</ul>
			</div>
			...
			<s:elseif test="comment">
				<%@include file="CommentMessage.jsp" %>
				<div class="friends_nav" style="background:#FBF5EB;width:200px;">
					<fieldset class="S_line2" style="margin:20px 0 0;color:#423009;font-size:15px;">
						<legend class="tit S_txt1">广告位招租</legend>
					</fieldset>
			...
			<s:elseif test="commun">
				<%@include file="CommunMessage.jsp" %>
				<div class="friends_nav" style="background:#FBF5EB;width:200px;">
					<fieldset class="S_line2" style="margin:20px 0 0;color:#423009;font-size:15px;">
						<legend class="tit S_txt1">广告位招租</legend>
					</fieldset>
