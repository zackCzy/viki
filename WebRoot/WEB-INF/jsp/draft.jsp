...
<html>
	<head>
		...
		<script type="text/javascript" src="${pageContext.request.contextPath}/JS/draftBox.js"></script>
		<title>${sgin}_的草稿箱</title>
	</head>
	<body>
		<%@ include file="/WEB-INF/jsp/head.jsp"%>
			<div class="draftBox">
				<h2 class="draft_title">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;草稿箱&nbsp;(&nbsp;<span><s:property value="#userlogs.size()"/> </span>&nbsp;)<a href="${pageContext.request.contextPath}/user/function_cteateDiary">返回发布页</a></h2>
				...
				<div class="draftRow">
					<ul>
						<s:iterator value="#userlogs" var="log">	
							...
							<a class="recovery" href="${pageContext.request.contextPath}/user/function_modifyDiary?userId=<s:property value="id" />">编辑</a>
